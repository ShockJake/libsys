    ...
    public void run(ApplicationArguments args) throws Exception {
        if (messagesRepository.count() == 0) {
            ...
            List<Message> messages = List.of(
                    new Message(null, "Thank you for becoming our Administrator", 2L, 2L, MessageStatus.UNREAD),
                    new Message(null, "Thank you for becoming our Writer", 3L, 2L, MessageStatus.UNREAD),
                    new Message(null, "Thank you for becoming out Reader", 4L, 2L, MessageStatus.UNREAD)
            );
