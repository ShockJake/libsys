...
public class RequestManagerController {
    ...
    public RequestManagerController(LibsysRequestService requestService) {
        this.requestService = requestService;
    }

    @GetMapping("/{id}")
    public LibsysRequest getRequest(@PathVariable Long id) throws RequestNotFoundException {
